...
class UserSeeder extends Seeder
{
    ...
    {
        User::updateOrCreate(['email' => 'admin@cropguidance.com'], ['name' => 'Admin Manager', 'password' => Hash::make('password'), 'role' => 'admin', 'state' => 'Maharashtra', 'district' => 'Pune', 'phone' => '9876543210']);
